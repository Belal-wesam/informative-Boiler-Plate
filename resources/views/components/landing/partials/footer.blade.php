 <!-- Footer -->
 <footer id="footer" class="footer" data-bg-img="/landing/assets/images/footer-bg.png" data-bg-color="#001018">
     <div class="container pt-70 pb-40">
         <div class="row border-bottom-black" style="display: flex;justify-content:space-between;">
             <div class="col-sm-6 col-md-3">
                 <div class="widget dark">
                     <img class="mt-10 mb-20" alt="" src="/landing/assets/images/logo-wide-white-footer.png">
             ...
             <div class="col-sm-6 col-md-3">
                 <div class="widget dark">
                     <h5 class="widget-title line-bottom">{{ __('links') }}</h5>
                     <ul class="list angle-double-right list-border">
                         <li><a href="{{ route('landing.index') }}">{{ __('home') }}</a></li>
                         <li><a href="{{ route('landing.about') }}">{{ __('about') }}</a></li>
                         <li><a href="{{ route('landing.services') }}">{{ __('services') }}</a></li>
                         <li><a href="{{ route('landing.projects') }}">{{ __('projects') }}</a></li>
                         <li><a href="{{ route('landing.blog') }}">{{ __('blog') }}</a></li>
                     </ul>
                 </div>
             </div>
             <div class="col-sm-6 col-md-3">
                 <div class="widget dark">
                     ...
                     <form id="footer_quick_contact_form" name="footer_quick_contact_form" class="quick-contact-form"
                         ...
                         <div class="form-group">
                             <textarea id="form_message" name="form_message" class="form-control" required="" placeholder="{{ __('message') }}"
                                 rows="3"></textarea>
                         </div>
                         <div class="form-group">
     ...
     <div class="footer-bottom" data-bg-color="#001111">
         <div class="container pt-15 pb-10">
             <div class="row">
                 <div class="col-md-12">
                     <p class="font-12 text-gray m-0 text-center">Copyright &copy;2024 <span
                             class="text-theme-colored">Recovery</span>. All Rights Reserved</p>
                 </div>
             </div>
         </div>
     </div>
