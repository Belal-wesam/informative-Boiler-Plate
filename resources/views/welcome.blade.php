<x-landing.layout.app title="index page">
    <x-slot:slot>
        <section id="home">
                    ...
                    <div class="rev_slider rev_slider_default" data-version="5.0">
                        <ul>
                            ...
                            <li data-index="rs-1" data-transition="fade" data-slotamount="default" data-easein="default"
                                ...
                                data-thumb="http://placehold.it/1920x1080" data-rotate="0" data-fstransition="fade"
                                ...
                                <img src="http://placehold.it/1920x1080" alt="" data-bgposition="center center"
                                    data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="6"
                                    data-no-retina>
                                <!-- LAYERS -->

                                <!-- LAYER NR. 1 -->
                                <div class="tp-caption tp-resizeme sft text-black-222 text-uppercase font-raleway bg-theme-colored pl-20 pr-20"
                                    id="rs-1-layer-1" data-x="['left']" data-hoffset="['30']" data-y="['middle']"
                                ...
                                <div class="tp-caption tp-resizeme sft text-uppercase text-white font-raleway font-weight-700 m-0"
                                    ...
                                    data-responsive_offset="on"
                                    style="z-index: 5; white-space: nowrap; font-weight:700;">Industry<span
                                        class="text-theme-colored"> Press</span>
                                </div>

                                <!-- LAYER NR. 3 -->
                                <div class="tp-caption tp-resizeme sft text-white" id="rs-1-layer-3" data-x="['left']"
                                    data-hoffset="['30']" data-y="['middle']" data-voffset="['20']"
                                    ...
                                    data-responsive_offset="on"
                                    style="z-index: 5; white-space: nowrap; font-weight:400;">We provides always our
                                    best industrial solution for our clients <br>and always try to achieve our client's
                                    trust and satisfaction.
                                </div>

                                <!-- LAYER NR. 4 -->
                                <div class="tp-caption sft" id="rs-1-layer-4" data-x="['left']" data-hoffset="['30']"
                                    data-y="['middle']" data-voffset="['90','100','110']" data-width="none"
                                    data-height="none" data-whitespace="nowrap" data-transform_idle="o:1;s:500"
                                    data-transform_in="y:100;scaleX:1;scaleY:1;opacity:0;"
                                    data-transform_out="x:left(R);s:1000;e:Power3.easeIn;s:1000;e:Power3.easeIn;"
                                    data-mask_in="x:0px;y:0px;s:inherit;e:inherit;"
                            ...
                            <li data-index="rs-2" data-transition="fade" data-slotamount="default"
                                ...
                                <!-- LAYER NR. 1 -->
                                <div class="tp-caption tp-resizeme sft text-black-222 text-uppercase font-raleway bg-theme-colored pl-20 pr-20"
                                    id="rs-2-layer-1" data-x="['right']" data-hoffset="['30']" data-y="['middle']"
                                    data-voffset="['-125']" data-fontsize="['24']" data-lineheight="['48']"
                                    data-width="none" data-height="none" data-whitespace="nowrap"
                                    data-transform_idle="o:1;s:500"
                                    data-transform_in="y:100;scaleX:1;scaleY:1;opacity:0;"
                                    ...
                                    data-start="600" data-splitin="none" data-splitout="none"
                                    data-responsive_offset="on"
                                    style="z-index: 5; white-space: nowrap; font-weight:700; border-right: 8px solid #fff;">
                                    Best Industrial Services Provider
                                </div>
                                ...
                                <!-- LAYER NR. 3 -->
                                <div class="tp-caption tp-resizeme sft text-white text-right" id="rs-2-layer-3"
                                ...
                                <!-- LAYER NR. 4 -->
                                <div class="tp-caption sft" id="rs-2-layer-4" data-x="['right']"
                                    ...
                                    data-responsive_offset="on"
                                    style="z-index: 5; white-space: nowrap; letter-spacing:1px;"><a
                                        class="btn btn-default btn-transparent btn-bordered btn-lg btn-flat font-weight-600 pl-30 pr-30 mr-15"
                                        href="#">Get a Quote</a><a
                                        class="btn btn-theme-colored btn-lg btn-flat text-black-222 font-weight-600 pl-30 pr-30"
                                        href="#">Our Service</a>
                                </div>
                            </li>
                            ...
                            <li data-index="rs-3" data-transition="fade" data-slotamount="default"
                                ...
                                <!-- LAYER NR. 1 -->
                                <div class="tp-caption tp-resizeme sft text-black-222 text-uppercase font-raleway bg-theme-colored pl-20 pr-20"
                                    id="rs-3-layer-1" data-x="['left']" data-hoffset="['30']" data-y="['middle']"
                                    data-voffset="['-125']" data-fontsize="['24']" data-lineheight="['48']"
                                    data-width="none" data-height="none" data-whitespace="nowrap"
                                    data-transform_idle="o:1;s:500"
                                    data-transform_in="y:100;scaleX:1;scaleY:1;opacity:0;"
                                ...
                                <!-- LAYER NR. 3 -->
                                <div class="tp-caption tp-resizeme sft text-white" id="rs-3-layer-3"
                                ...
                                <!-- LAYER NR. 4 -->
                                <div class="tp-caption sft" id="rs-3-layer-4" data-x="['left']"
                                    data-hoffset="['30']" data-y="['middle']" data-voffset="['90','100','110']"
                                    data-width="none" data-height="none" data-whitespace="nowrap"
                                    data-transform_idle="o:1;s:500"
                                    data-transform_in="y:100;scaleX:1;scaleY:1;opacity:0;"
