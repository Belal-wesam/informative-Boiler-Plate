...
@section('content')
    <div class="card">
        <div class="card-header border-bottom d-flex align-items-center justify-content-between">
            <h5 class="card-title mb-0">@lang('nav.faq')</h5>
            {{-- check if auth user has ability to create  --}}
            @if (auth('admin')->user()->hasAbilityTo('create faq'))
                <button class="btn btn-primary" data-bs-target="#addFaqModal" data-bs-toggle="modal"><i
                        class="bx bx-plus me-0 me-lg-2"></i><span
                        class="d-none d-lg-inline-block">{{ __('add new faq') }}</span></button>
            @endif
        </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group mb-3">
                                    <label for="name" class="form-label">{{ __('question en') }}</label>
                                    <input type="text" name="question_en" placeholder="{{ __('question en') }}"
                                        id="question_en" class="form-control">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="form-group mb-3">
                                    <label for="name" class="form-label">{{ __('question ar') }}</label>
                                    <input type="text" name="question_ar" placeholder="{{ __('question ar') }}"
                                        id="question_ar" class="form-control">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="form-group mb-3">
                                    <label for="name" class="form-label">{{ __('answer en') }}</label>
                                    <textarea name="answer_en" id="answer_en" cols="30" rows="7" class="form-control"
                                        placeholder="{{ __('answer en') }}"></textarea>
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="form-group mb-3">
                                    <label for="name" class="form-label">{{ __('answer ar') }}</label>
                                    <textarea name="answer_ar" id="answer_ar" cols="30" rows="7" class="form-control"
    ...
    <div class="modal fade" id="editFaqModal" tabindex="-1" aria-labelledby="editFaqModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editFaqModalLabel">@lang('general.edit')</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="#" id="editCategoryForm">
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group mb-3">
                                    <label for="name" class="form-label">{{ __('question en') }}</label>
                                    <input type="text" name="edit_question_en" placeholder="{{ __('question en') }}"
                                        id="edit_question_en" class="form-control">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="form-group mb-3">
                                    <label for="name" class="form-label">{{ __('question ar') }}</label>
                                    <input type="text" name="edit_question_ar" placeholder="{{ __('question ar') }}"
                                        id="edit_question_ar" class="form-control">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="form-group mb-3">
                                    <label for="name" class="form-label">{{ __('answer en') }}</label>
                                    <textarea name="edit_answer_en" id="edit_answer_en" cols="30" rows="7" class="form-control"
                                        placeholder="{{ __('answer en') }}"></textarea>
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="form-group mb-3">
                                    <label for="name" class="form-label">{{ __('answer ar') }}</label>
                                    <textarea name="edit_answer_ar" id="edit_answer_ar" cols="30" rows="7" class="form-control"
                                        placeholder="{{ __('answer ar') }}"></textarea>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        $('document').ready(function() {
            ...
            $('body').on('click', '.edit-btn', function() {
                $('#edit_question_en').val($(this).data('question-en'))
                $('#edit_question_ar').val($(this).data('question-ar'))
                $('#edit_answer_ar').val($(this).data('answer-ar'))
                $('#edit_answer_en').val($(this).data('answer-en'))
            ...
            $('body').on('click', '#submit-edit-btn', function() {
                let data = {
                    ...
                    question_ar: $('#edit_question_ar').val(),
                    answer_en: $('#edit_answer_en').val(),
                    answer_ar: $('#edit_answer_ar').val(),
                    id: $('#edit_id').val(),
                }
                let formBtn = $(this) // the button that sends the reuquest (to minipulate ui)
