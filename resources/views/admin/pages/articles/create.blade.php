...
@section('content')
    <div class="card">
        <div class="card-header border-bottom d-flex align-items-center justify-content-between">
            <h5 class="card-title mb-0">{{ __('add new articles') }}</h5>
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="title_en" id="title_en" placeholder="{{ __('title en') }}"
                                class="form-control">
                            @error('title_en')
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="title_ar" id="title_ar" placeholder="{{ __('title ar') }}"
                                class="form-control">
                            @error('title_ar')
                                <small class="text-danger">
                                    {{ $message }}
                    ...
                    <div class="col-12">
                        <div class="form-group mb-3">
                            ...
                            <textarea name="body_en" id="body_en" cols="30" rows="7" class="form-control"
                                placeholder="{{ __('body en') }}"></textarea>
                            @error('body_en')
                                <small class="text-danger">
                                    {{ $message }}
                                </small>
                    ...
                    <div class="col-12">
                        <div class="form-group mb-3">
                            ...
                            <textarea name="body_ar" id="body_ar" cols="30" rows="7" class="form-control"
                                placeholder="{{ __('body ar') }}"></textarea>
                            @error('body_ar')
                                <small class="text-danger">
                                    {{ $message }}
                                </small>
